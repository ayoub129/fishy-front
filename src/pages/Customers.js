...
import CustomersTable from "../componenet/CustomersTable";
...
const Customers = () => {
  ...
  const handleSalesExcel = () => {
    ...
    axios({
      method: "post",
      url: "https://fishys.000webhostapp.com/upload.php?table=customers",
      // url: "http://localhost/fish/api2/upload.php?table=customers",
      data: fd,
